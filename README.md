...
<title>LexCity — Precision Counsel</title>
...
<header>
  <div class="logo">LEX<span>CITY</span></div>
  <div class="navlinks">
    <ul>
...
<section class="hero">
  ...
  <div class="hero-inner">
    ...
    <p>LexCity represents founders, funds, and litigants who cannot afford an ordinary outcome. Twenty-two years of judgment, sharpened for the cases that decide everything.</p>
...
<footer>
  ...
  <div>© 2026 LexCity LLP. Attorney advertising.</div>
</footer>
